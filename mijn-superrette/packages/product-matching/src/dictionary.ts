...
export const DEFAULT_DICTIONARY: NormalizerDictionary = {
  ...
  variantTokens: ['zero', 'light', 'cafeinevrij', 'halfvol', 'vol', 'mager', 'volkoren', 'wit', 'scharrel', 'vrije-uitloop'],
  flavourTokens: ['cherry', 'kers', 'lime', 'citroen', 'lemon', 'vanille', 'vanilla', 'mint', 'munt', 'aardbei', 'fraise'],
  dietary: {
    bio: 'organic',
  ...
  stopwords: [
    'fles', 'bouteille', 'bottle', 'pet', 'blik', 'canette', 'can', 'pak', 'brik', 'brique', 'doos', 'boite',
    'zak', 'sachet', 'stuk', 'stuks', 'st', 'pieces', 'piece', 'de', 'het', 'een', 'le', 'la', 'les', 'du',
