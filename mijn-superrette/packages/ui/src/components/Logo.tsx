...
export function LogoMark({ size = 48 }: { size?: number }): ReactNode {
  return (
    <Svg width={size} height={size} viewBox="0 0 64 64" accessibilityLabel="Mijn Superrette">
      ...
      <Path d="M40 12.5 C37.5 9.6 26 9.2 26 14.6 C26 19.4 39 17.8 39 22.8 C39 25.6 34 26.4 25.5 25.2" stroke={palette.paper} strokeWidth={4.4} strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      <Line x1={26} y1={38.5} x2={26.7} y2={49} stroke={palette.ink} strokeOpacity={0.35} strokeWidth={2.4} strokeLinecap="round" />
      <Line x1={32} y1={38.5} x2={32} y2={49} stroke={palette.ink} strokeOpacity={0.35} strokeWidth={2.4} strokeLinecap="round" />
      <Line x1={38} y1={38.5} x2={37.3} y2={49} stroke={palette.ink} strokeOpacity={0.35} strokeWidth={2.4} strokeLinecap="round" />
    </Svg>
  );
}
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: size * 0.28 }}>
      ...
      <View>
        ...
        <Text variant="title" style={{ color: inverted ? palette.paper : undefined, marginTop: -2, fontSize: size * 0.55, lineHeight: size * 0.65 }}>
          Superrette
        </Text>
      </View>
    </View>
