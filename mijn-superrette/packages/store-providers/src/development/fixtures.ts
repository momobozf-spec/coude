...
export const DEV_PRODUCTS: DevProduct[] = [
  ...
  own('delhaize-halfvolle-melk-1l', 'zuivel', 'delhaize', 'Delhaize Lait demi-écrémé / Halfvolle melk 1 L', 115, { gtinNo: 11 }),
  own('ah-halfvolle-melk-1l', 'zuivel', 'albert-heijn', 'AH Halfvolle melk', 109, { quantityText: '1 liter', gtinNo: 12 }),
  ...
  same('arla-lactofree-halfvol-1l', 'zuivel', 21, {
  ...
  same('philadelphia-original-200', 'zuivel', 22, {
  ...
  own('delhaize-volkoren-brood', 'brood', 'delhaize', 'Delhaize Pain complet / Volkoren brood 800 g', 209, { gtinNo: 31 }),
  ...
  own('delhaize-eieren-12', 'eieren', 'delhaize', 'Delhaize Oeufs plein air / Eieren vrije uitloop 12 stuks', 349, { gtinNo: 41 }),
  ...
  same('barilla-spaghetti-5-500', 'voorraad', 81, {
  ...
  same('douwe-egberts-aroma-rood-500', 'voorraad', 82, {
  ...
  // ── Diepvries ──────────────────────────────────────────────────────────
  same('iglo-vissticks-10', 'diepvries', 90, {
...
export const DEV_PROMOTIONS: DevPromotion[] = [
  { externalId: 'ah-cola-2voor4', retailer: 'albert-heijn', productKeys: ['coca-cola-zero-15', 'coca-cola-original-15'], params: { mechanic: 'MULTI_BUY_FIXED_PRICE', quantity: 2, totalCents: 400 }, label: '2 voor €4', startsInDays: -2, endsInDays: 5 },
  { externalId: 'delhaize-pampers-2e-halve', retailer: 'delhaize', productKeys: ['pampers-baby-dry-4-44'], params: { mechanic: 'NTH_ITEM_PERCENT_OFF', nth: 2, percent: 50 }, label: '2e aan halve prijs', startsInDays: -4, endsInDays: 3 },
  { externalId: 'colruyt-lotus-1plus1', retailer: 'colruyt', productKeys: ['lotus-speculoos-250'], params: { mechanic: 'BUY_X_GET_Y_FREE', buy: 1, free: 1 }, label: '1+1 gratis', startsInDays: -1, endsInDays: 1 },
  { externalId: 'jumbo-campina-3voor4', retailer: 'jumbo', productKeys: ['campina-halfvolle-melk-1l'], params: { mechanic: 'MULTI_BUY_FIXED_PRICE', quantity: 3, totalCents: 400 }, label: '3 voor €4', startsInDays: -3, endsInDays: 4 },
  { externalId: 'ah-kipfilet-bonus', retailer: 'albert-heijn', productKeys: ['ah-kipfilet-500'], params: { mechanic: 'PERCENT_OFF', percent: 25 }, label: 'Bonus -25%', startsInDays: -1, endsInDays: 6, loyaltyProgram: 'bonuskaart' },
  { externalId: 'delhaize-colgate-superplus', retailer: 'delhaize', productKeys: ['colgate-total-75'], params: { mechanic: 'PERCENT_OFF', percent: 20 }, label: 'SuperPlus -20%', startsInDays: -5, endsInDays: 9, loyaltyProgram: 'superplus' },
  { externalId: 'colruyt-eieren-50ct', retailer: 'colruyt', productKeys: ['boni-scharreleieren-12'], params: { mechanic: 'AMOUNT_OFF', amountCents: 50 }, label: '€0,50 korting', startsInDays: -2, endsInDays: 12 },
  { externalId: 'lidl-spaghetti-price-cut', retailer: 'lidl', productKeys: ['barilla-spaghetti-5-500'], params: { mechanic: 'PRICE_CUT', promoPriceCents: 119 }, label: 'Nu €1,19', startsInDays: -1, endsInDays: 5 },
  { externalId: 'jumbo-iglo-2plus1', retailer: 'jumbo', productKeys: ['iglo-vissticks-10'], params: { mechanic: 'BUY_X_GET_Y_FREE', buy: 2, free: 1 }, label: '2+1 gratis', startsInDays: -6, endsInDays: 1 },
  { externalId: 'colruyt-pampers-next-week', retailer: 'colruyt', productKeys: ['pampers-baby-dry-4-44'], params: { mechanic: 'PERCENT_OFF', percent: 30 }, label: '-30% (volgende week)', startsInDays: 7, endsInDays: 14 },
];
